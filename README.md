...
Eu desenvolvi uma aplicação que consiste em uma biblioteca de cartões de filmes dinâmica utilizando React. A biblioteca é composta por:
...
```javascript
  ...
  git clone git@github.com:Humberto-Bonadiman/Project-movie-cards-library-stateful.git
```
...
4. Por último, rode o comando **npm start** e acesse o projeto via browser, no caminho `http://localhost:3000/Project-movie-cards-library-stateful`.
